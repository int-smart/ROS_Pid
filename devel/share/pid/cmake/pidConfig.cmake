...
if("TRUE" STREQUAL "TRUE")
  set(pid_SOURCE_PREFIX /home/abhishek/catkin_ws/src/pid)
  set(pid_DEVEL_PREFIX /home/abhishek/catkin_ws/devel)
  set(pid_INSTALL_PREFIX "")
  set(pid_PREFIX ${pid_DEVEL_PREFIX})
else()
  set(pid_SOURCE_PREFIX "")
  set(pid_DEVEL_PREFIX "")
  set(pid_INSTALL_PREFIX /home/abhishek/catkin_ws/install)
...
if(NOT "/home/abhishek/catkin_ws/devel/include " STREQUAL " ")
  set(pid_INCLUDE_DIRS "")
  set(_include_dirs "/home/abhishek/catkin_ws/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'pid' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'abhishek <abhishek@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'pid' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/abhishek/catkin_ws/src/pid/${idir}'.  Ask the maintainer 'abhishek <abhishek@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/abhishek/catkin_ws/devel/lib;/home/abhishek/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
